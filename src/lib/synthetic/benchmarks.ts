...
export const BENCHMARK_SEEDS: BenchmarkSeed[] = [
  {
    code: '99213',
    label: 'Office visit, established, level 3',
    median: 145,
    p25: 110,
    p75: 190,
    sampleSize: 4200,
  ...
  {
    code: '99214',
    label: 'Office visit, established, level 4',
    median: 210,
    p25: 165,
    p75: 270,
    sampleSize: 3800,
  ...
  {
    code: '99244',
    label: 'Office consultation, level 4',
    median: 360,
    p25: 280,
    p75: 470,
    sampleSize: 900,
  ...
  {
    code: '85025',
    label: 'Complete blood count w/ differential',
    median: 48,
    p25: 32,
    p75: 70,
    sampleSize: 5000,
  ...
  {
    code: '00840',
    label: 'Anesthesia, lower abdomen',
    median: 1200,
    p25: 850,
    p75: 1650,
    sampleSize: 700,
  ...
  {
    code: 'J7030',
    label: 'Normal saline IV, 1000 ml',
    median: 90,
    p25: 55,
    p75: 130,
    sampleSize: 1700,
  ...
  {
    code: '90471',
    label: 'Immunization administration',
    median: 40,
    p25: 28,
    p75: 58,
    sampleSize: 2200,
  ...
  {
    code: '99204',
    label: 'Office visit, new patient, level 4',
    median: 320,
    p25: 250,
    p75: 410,
    sampleSize: 1900,
  ...
  {
    code: '81002',
    label: 'Urinalysis, non-automated',
    median: 18,
    p25: 12,
    p75: 28,
    sampleSize: 3400,
